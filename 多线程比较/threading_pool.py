...
if __name__ == "__main__":
    ...
    filename = "./data/anjuke_data_tp.csv"
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for page in range(1, max_pages + 1):
            ...
            futures.append(executor.submit(fetch_page, url, headers, filename))
            sleep_time = random.uniform(1, 3)  # 随机延时，避免反爬
            sleep(sleep_time)
